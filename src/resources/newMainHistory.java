...
public class newMainHistory {
    public static void main(String[] args) {
        ...
        Task task2 = new Task("Задача 2", "Описание 2",  Duration.ofMinutes(35), LocalDateTime.of(2025, 01, 04, 00, 00));
        Task task1 = new Task("Задача 1", "Описание 1", Duration.ofSeconds(50), null);
        Task task3 = new Task("Задача 2", "Описание 2",  Duration.ofMinutes(35), LocalDateTime.of(2026, 02, 04, 00, 00)); //id = 2
        ...
        //System.out.println(historyManager.getHistoryTask().toString());
