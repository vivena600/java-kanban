...
public class InMemoryHistoryManagerTest {
    ...
    static void Tasks() {
        ...
        subTask6 = new SubTask("title8", "discription8", 8);
        task2 = new Task("title9", "discription9");
    ...
    void getHistoryTask() {
        ...
        assertEquals(task2, taskManager.getHistory().get(0), "Не корректно записываются элементы списка");
        assertEquals(subTask6, taskManager.getHistory().get(9), "Не корректно записываются элементы списка");
    }
}
